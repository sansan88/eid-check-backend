        ...
        request.post({
            ...
            (err, httpResponse, body) => {
                ...
                request({
                    ...
                    //Verification
                    if (userDataBody && userDataBody["verified_simple"]) {
        ...
        request.post({
            ...
            (err, httpResponse, body) => {
                ...
                request({
                    ...
                    if (  returnData.is18 || returnData.is16 ){ // NUR WENN eine prüfung TRUE ist, wird foto übermittelt! 
                        returnData.picture = userDataBody.picture;
                    }
